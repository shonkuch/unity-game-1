...
namespace UnityLab.Components
{
    ...
    public class Obstacle : MonoBehaviour
    {
        ...
        private void TryReport(GameObject target)
        {
            ...
            if(response == ObstacleResponse.Damage && target.TryGetComponent<Health>(out var healthComponent))
            {
            ...
            GameController.Instance.OnObstacleHit(new ObstacleHit(this, target, response, damageAmount));
        }
    }
}
